...
public class RegistryHandler {
    ...
    public static void clientSetup(FMLClientSetupEvent event) {
        ...
        ClientRegistry.bindTileEntityRenderer(RegistryHandler.CARD_DISPLAY_TILE.get(), CardDisplayTileRenderer::new);
    }
    ...
    //Binders
    public static final RegistryObject<Item> BINDER_BASE = ITEMS.register("binder.1", BinderItem::new);
    public static final RegistryObject<Item> BINDER_NETHER = ITEMS.register("binder.2", BinderItem::new);
    public static final RegistryObject<Item> BINDER_END = ITEMS.register("binder.3", BinderItem::new);
    ...
    //Tile Entity
    public static final RegistryObject<TileEntityType<CardDisplayTile>> CARD_DISPLAY_TILE = TILE_ENTITIES.register("card_display", () -> TileEntityType.Builder.create(CardDisplayTile::new,
            OAK_CARD_DISPLAY.get(), SPRUCE_CARD_DISPLAY.get(), BIRCH_CARD_DISPLAY.get(), JUNGLE_CARD_DISPLAY.get(),
            ACACIA_CARD_DISPLAY.get(), DARK_OAK_CARD_DISPLAY.get(), CRIMSON_CARD_DISPLAY.get(), WARPED_CARD_DISPLAY.get()).build(null));
}
