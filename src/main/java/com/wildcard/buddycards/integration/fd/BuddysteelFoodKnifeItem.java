...
public class BuddysteelFoodKnifeItem extends KnifeItem {
    public BuddysteelFoodKnifeItem() {
        super(BuddysteelItemTier.BUDDYSTEEL, 1, -1.8f, new Item.Properties().group(BuddyCards.TAB));
    }
    ...
    public Multimap<Attribute, AttributeModifier> getAttributeModifiers(EquipmentSlotType slot, ItemStack stack) {
        ...
        if (stack.hasTag() && slot == EquipmentSlotType.MAINHAND) {
            ...
            multimap.put(Attributes.ATTACK_SPEED, new AttributeModifier(ATTACK_SPEED_MODIFIER, "Weapon modifier", -1.8, AttributeModifier.Operation.ADDITION));
        }
        return multimap;
    }
}
